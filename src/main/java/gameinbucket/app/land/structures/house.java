...
public abstract class house {
    ...
    public static sector[] make(state s, int x, int y) {
        vector[] p = { new vector(x, y), new vector(x, y + 20), new vector(x + 6, y + 20), // 2
                new vector(x + 6, y + 19), new vector(x + 1, y + 19), new vector(x + 1, y + 1),
                new vector(x + 19, y + 1), new vector(x + 19, y + 19), new vector(x + 14, y + 19),
                new vector(x + 14, y + 20), // 9
                new vector(x + 20, y + 20), new vector(x + 20, y), };

...
public abstract class complex {
    ...
    public static sector make(state s, int x, int y) {
        vector[] p = { new vector(x + 0, 0 + y), new vector(x + 0, 5 + y), new vector(x + 3, 5 + y),
                new vector(x + 5, 10 + y), new vector(x + 10, 10 + y), new vector(x + 10, 5 + y),
                new vector(x + 5, 5 + y), new vector(x + 5, 0 + y), };

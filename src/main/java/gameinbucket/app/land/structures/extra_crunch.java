...
public abstract class extra_crunch {
    ...
    public static sector make(state s, int x, int y) {
        vector[] p = { new vector(x, y), new vector(x - 1, y + 2), new vector(x, y + 4), new vector(x + 1, y + 3),
                new vector(x + 2, y + 4), new vector(x + 3, y + 2), new vector(x + 2, y), new vector(x + 1, y + 1), };

...
public abstract class letter_h {
    ...
    public static sector make(state s) {
        vector[] p = { new vector(0, 0), new vector(0, 20), new vector(5, 20), new vector(5, 15), new vector(10, 15),
                new vector(10, 20), new vector(15, 20), new vector(15, 0), new vector(10, 0), new vector(10, 10),
                new vector(5, 10), new vector(5, 0), };

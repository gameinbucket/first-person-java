    ...
    protected void overlap(linedef line)
    {
        ...
        if (collision)
        {
            ...
            if (endpoint)
            {
                ...
                overlap = (float)Math.sqrt((px + radius * ex) * (px + radius * ex) + (py + radius * ey) * (py + radius * ey));
            ...
            {
                overlap = (float)Math.sqrt((px + radius * line.nx) * (px + radius * line.nx) + (py + radius * line.ny) * (py + radius * line.ny));

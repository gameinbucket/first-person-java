...
import land.things.base.entity;
...
public class you extends thing
{
    ...
    public void integrate()
    {
        ...
        if (ground)
        {
            ...
            /*
            if (keyboard.down(GLFW_KEY_SPACE))
            {
                if (keyboard.down(GLFW_KEY_W) && sticky_action == false)
                {
                    ...
                    {
                        dx = +(float)Math.sin(r) * vault;
                        dy = -(float)Math.cos(r) * vault;
                        dz = jump;
                ...
                else if (keyboard.down(GLFW_KEY_S) && sticky_action == false)
                {
                    dx = -(float)Math.sin(r) * vault;
                    dy = +(float)Math.cos(r) * vault;
                    dz = jump;
                ...
                else if (keyboard.down(GLFW_KEY_A) && sticky_action == false)
                {
                    dx = -(float)Math.cos(r) * vault;
                    dy = -(float)Math.sin(r) * vault;
                    dz = jump;
                    
                    sticky_action = true;
                    ground = false;
                }
                else if (keyboard.down(GLFW_KEY_D) && sticky_action == false)
                {
                    dx = (float)Math.cos(r) * vault;
                    dy = (float)Math.sin(r) * vault;
                    dz = jump;
        ...
        if (look < -view) look = -view;
        else if (look > view) look = view;

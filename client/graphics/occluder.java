...
public class occluder
{
    ...
    {
        if (frustum[0][0] * x + frustum[0][2] * z + frustum[0][3] <= 0) return true;
        if (frustum[1][0] * x + frustum[1][2] * z + frustum[1][3] <= 0) return true;
    ...
    {
        if (frustum[0][0] * x + frustum[0][2] * z + frustum[0][3] <= -radius) return true;
        if (frustum[1][0] * x + frustum[1][2] * z + frustum[1][3] <= -radius) return true;

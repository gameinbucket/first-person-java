...
public abstract class matrix
{
    ...
    public static void orthographic(float[] m, float left, float top, float right, float bottom, float near, float far)
    {
        m[0] = 2.0f / (right - left);
        m[1] = 0.0f;
        m[2] = 0.0f;
    ...
    public static void rotate_x(float[] m, float sin, float cos)
    {
        ...
        for (int i = 0; i < 16; i++) copied[i] = m[i];
    ...
    public static void inverse(float[] m, float[] m1)
    {
        ...
        for (int i = 0; i < 16; i++) m[i] = dst[i] * det;
    }
